...
const ReceiptsList = () => {
    ...
    // Calculate totals
    const totalSpent = receipts.reduce((sum, r) => sum + (r.buy), 0);
    const totalIncome = receipts.reduce((sum, r) => sum + (r.income || 0), 0);
        ...
        <div className="app-body">
            <div className="container">
                    ...
                    <div className="col-12 col-xl-6">
                        <ol className="breadcrumb mb-3 align-items-center">
                            <li className="breadcrumb-item">
                                ...
                                <a href="/public" className="text-decoration-none ms-1">
                                    Home
                                </a>
                            </li>
                ...
                <div className="row gx-3">
                    ...
                    <span className="badge rounded-pill bg-success px-4 py-2 fs-6 d-flex align-items-center gap-2 shadow-sm">
                      <i className="fa fa-arrow-up" />
                      <span>Total Income</span>
                      <span className="fw-bold">${totalIncome.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                    </span>
                                        <span className="badge rounded-pill bg-info text-dark px-4 py-2 fs-6 d-flex align-items-center gap-2 shadow-sm">
                      <i className="fa fa-arrow-down" />
                      <span>Total Spent</span>
                      <span className="fw-bold">${totalSpent.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                    </span>
                      ...
                      <span className="fw-bold">${totalCost.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                            ...
                            <span className="badge bg-light text-dark px-2 py-1 shadow-sm">
                              {row.buy}
                                                ...
                                                <td>
                            <span className="badge bg-info text-dark px-2 py-1 fw-semibold shadow-sm">
                              {row.income}
                            </span>
                                                </td>
                                                <td>
