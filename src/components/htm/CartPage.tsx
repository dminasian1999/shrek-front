...
const CartPage = () => {
  ...
  // )
  const cart = useAppSelector(state =>
    state.user.profile.cart  )

  const user = useAppSelector(state => state.user.profile)
  const token = useAppSelector(state => state.token)
  const [products, setProducts] = useState([] as ProductT[])
  useEffect(() => {if (Array.isArray(cart) && cart.length > 0) {
    const ids = cart.map(item => item.id);
    getPostByIds(ids, token).then(setProducts);
  }
  }, [setProducts]);
                  ...
                  { products && products.map(p => (
                    <tr className="cart__row border-bottom line1 cart-flex border-top">
                      <td className="cart__image-wrapper cart-flex-item">
                        <a href="#">
                          <img
                            ...
                            // src="src/images/product-images/product-image30.jpg"
                            src={p.imageUrl}
                      ...
                      <td className="cart__price-wrapper cart-flex-item">
                        <span className="money">${p.sell}</span>
                      </td>
                  ...
                  <tr className="cart__row border-bottom line1 cart-flex border-top">
                    <td className="cart__image-wrapper cart-flex-item">
                      <a href="#">
                        <img
                          className="cart__image"
                          src="src/images/product-images/home7-product5.jpg"
                  ...
                  <tr className="cart__row border-bottom line1 cart-flex border-top">
                    <td className="cart__image-wrapper cart-flex-item">
                      <a href="#">
                        <img
                          className="cart__image"
                          src="src/images/product-images/home7-product4.jpg"
