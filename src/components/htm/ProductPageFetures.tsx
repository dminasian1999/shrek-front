    ...
    <div className="prFeatures">
      <div className="row">
        ...
        <div className="col-12 col-sm-6 col-md-6 col-lg-3 feature">
          ...
          <div className="details"><h3>Worldwide Delivery</h3>FREE &amp; fast shipping to over 200+
            countries &amp; regions.
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-6 col-lg-3 feature">
          <img src="/src/images/phone-call.png" alt="Hotline" title="Hotline" />
          <div className="details"><h3>Hotline</h3>Talk to help line for your question on 4141 456 789, 4125 666
            888
          </div>
        </div>
      </div>
...
export default ProductPageFetures;
