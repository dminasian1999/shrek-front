...
const Header2 = () => {
  return (
    <>
      <nav className="navbar grid__item navbar-expand-lg   " id="AccessibleNav">
        <div className="container ">
          ...
          >
            <div className="offcanvas-header bg-secondary-subtle">
            ...
            <div className="offcanvas-body ">
              {/*<ul*/}
              {/*  id="siteNav"*/}
              {/*  className="navbar-nav  justify-content-center flex-grow-1 pe-3 site-nav medium center hidearrow"*/}
              {/*>*/}
              ...
              <ul className="dropdown">
                ...
                <li>
                  <a href="compare-variant1.html" className="site-nav">
                    Compare Product <i className="anm anm-angle-right-l"></i>
                  </a>
                  <ul className="dropdown">
                    <li>
                      <a href="compare-variant1.html" className="site-nav">
          ...
          <div className="d-block d-lg-none mobile-logo">
            <div className="logo">
              <a href="index.html">
                <img
                  src="http://localhost:63342/belle-multipurpose-bootstrap-html-template/assets/images/logo.svg"
                  alt="Belle Multipurpose Html Template"
                  title="Belle Multipurpose Html Template" />
              </a>
            </div>
