              ...
              <div className="zoompro-wrap product-zoom-right pl-20">
                ...
                <div className="product-labels">
                  ...
                  {Date.now() - new Date(product.dateCreated!).getTime() <
                    14 * 864e5 && <span className="lbl pr-label1">new</span>}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 col-md-6 col-sm-12 col-12">
            <div className="product-single__meta">
              ...
              <div className="prInfoRow">
                <div className="product-stock">
                  {product.quantity > 0 ? (
                    ...
                    <span className="outstock text-danger">Out of stock</span>
                  )}
                </div>
                ...
                <div className="product-review">
                  <a className="reviewLink" href="#tab2">
                    {[...Array(5)].map((_, i) => (
                      <i
                        key={i}
                        className={`font-13 fa ${i < randomStars ? "fa-star" : "fa-star-o"}`}
                      />
                    ))}
              ...
              <div className="orderMsg mt-2">
                ...
                <strong className="items">{itemsSold}</strong> sold in last{" "}
                <strong className="time">{hoursAgo}</strong> hours
              </div>

              <div className="product-single__description rte mt-3 text-break">
                {product.desc ||
              ...
              {product.quantity > 0 && (
                <div className="quantity_message mt-2">
                  Hurry! Only <span className="items">{product.quantity}</span>{" "}
                  left in stock.
                </div>
              )}
              ...
              <form>
                <div className="product-action d-flex  gap-2">
                  ...
                  <div className="shopify-payment-button w-100">
                    <button
                      type="button"
                      className="shopify-payment-button__butto  shopify-payment-button__button--unbranded w-100"
                    >
                      Buy it now
                    </button>
                  </div>
              ...
              <div className="userViewMsg mt-2">
                ...
                <strong className="uersView">{viewersNow}</strong> PEOPLE ARE
