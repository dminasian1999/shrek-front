...
const ProductPageSide = () => {
          ...
          <div className="product-details-img product-single__photos bottom">
            <div className="zoompro-wrap product-zoom-right pl-20">
              ...
              <div className="product-buttons">
                <a href="https://www.youtube.com/watch?v=93A2jOW5Mog" className="btn popup-video" title="View Video"><i
            ...
            <div className="product-thumb product-thumb-1">
              <div id="gallery" className="product-dec-slider-1 product-tab-left">
                <a data-image="src/images/product-detail-page/camelia-reversible-big1.jpg"
                   ...
                   className="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true"
                   tabIndex={-1}>
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible0.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big2.jpg"
                  ...
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big3.jpg"
                  ...
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible6.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible7-big.jpg"
                  ...
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible7.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big4.jpg"
                  ...
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible8.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big5.jpg"
                   ...
                   className="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true" tabIndex={-1}>
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible9.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big6.jpg"
                   ...
                   className="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true" tabIndex={-1}>
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible1.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big7.jpg"
                   ...
                   className="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" tabIndex={-1}>
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible2.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big8.jpg"
                  ...
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible3.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big9.jpg"
                  ...
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible4.jpg"
                       alt="" />
                </a>
                <a data-image="src/images/product-detail-page/camelia-reversible-big10.jpg"
                  ...
                  <img className="blur-up lazyload" src="src/images/product-detail-page/camelia-reversible5.jpg"
                       alt="" />
                </a>
              </div>
            </div>
          ...
          <div className="product-single__meta">
            ...
            <div className="prInfoRow">
              ...
              <div className="product-review"><a className="reviewLink" href="#tab2"><i
                ...
                className="font-13 fa fa-star-o"></i><span className="spr-badge-caption">6 reviews</span></a></div>
            </div>
  ...
  <span className="off">(<span>16</span>%)</span>
            ...
            <form method="post" action="http://annimexweb.com/cart/add" id="product_form_10508262282"
              ...
              <div className="swatch clearfix swatch-0 option1" data-option-index="0">
                <div className="product-form__item">
                  ...
                  <div data-value="Black" className="swatch-element color black available">
                    <input className="swatchInput" id="swatch-0-black" type="radio" name="option-0" value="Black" />
                    <label className="swatchLbl color small rounded" htmlFor="swatch-0-black"
                           style={{ backgroundColor: "black" }}
                           title="Black"></label>
                  </div>
                  <div data-value="Maroon" className="swatch-element color maroon available">
                    <input className="swatchInput" id="swatch-0-maroon" type="radio" name="option-0" value="Maroon" />
                    <label className="swatchLbl color small rounded"
                  ...
                  <div data-value="Dark Green" className="swatch-element color dark-green available">
                    <input className="swatchInput" id="swatch-0-dark-green" type="radio" name="option-0"
                           value="Dark Green" /><label className="swatchLbl color small rounded"
              ...
              <div className="swatch clearfix swatch-1 option2" data-option-index="1">
                <div className="product-form__item">
                  ...
                  <div data-value="XS" className="swatch-element xs available">
                    <input className="swatchInput" id="swatch-1-xs" type="radio" name="option-1" value="XS" /><label
                    className="swatchLbl small flat" htmlFor="swatch-1-xs" title="XS">XS</label>
                  </div>
                  <div data-value="S" className="swatch-element s available">
                    <input className="swatchInput" id="swatch-1-s" type="radio" name="option-1" value="S" /><label
                    className="swatchLbl small flat" htmlFor="swatch-1-s" title="S">S</label></div>
                  <div data-value="XL" className="swatch-element xl available">
                    <input className="swatchInput" id="swatch-1-xl" type="radio" name="option-1" value="XL" /><label
                    className="swatchLbl small flat" htmlFor="swatch-1-xl" title="XL">XL</label></div>
                </div>
              </div>
              ...
              <div className="product-action clearfix">
                ...
                <div className="shopify-payment-button" data-shopify="payment-button">
                  <button type="button"
                          className="shopify-payment-button__button shopify-payment-button__button--unbranded">Buy it
                    now
                  </button>
                </div>
              </div>
            ...
            <div className="product-info">
              <p className="product-type"><span className="lbl">Product Type:</span> <a
                href="http://annimexweb.com/collections/types?q=Women%27s" title="Women's">Women's</a></p>
              <p className="product-cat"><span className="lbl">Collections: </span><a
                href="http://annimexweb.com/collections/notifications" title="">Product Notifications</a> <a
                href="http://annimexweb.com/collections/women" title="">Women</a></p>
            </div>
          </div>
        </div>
                  ...
                  <div className="spr-header clearfix">
                    <div className="spr-summary">
                      <span className="product-review"><a className="reviewLink"><i
                        className="font-13 fa fa-star"></i><i className="font-13 fa fa-star"></i><i
                        className="font-13 fa fa-star"></i><i className="font-13 fa fa-star-o"></i><i
                        className="font-13 fa fa-star-o"></i> </a><span className="spr-summary-actions-togglereviews">Based on 6 reviews456</span></span>
                      ...
                      <form method="post" action="#" id="new-review-form" className="new-review-form">
                        ...
                        <fieldset className="spr-form-contact">
                          <div className="spr-form-contact-name">
                            ...
                            <input className="spr-form-input spr-form-input-text " id="review_author_10508262282"
                          ...
                          <div className="spr-form-contact-email">
                            ...
                            <input className="spr-form-input spr-form-input-email " id="review_email_10508262282"
                        ...
                        <fieldset className="spr-form-review">
                          <div className="spr-form-review-rating">
                            ...
                            <div className="spr-form-input spr-starrating">
                              <div className="product-review"><a className="reviewLink" href="#"><i
                                className="fa fa-star-o"></i><i className="font-13 fa fa-star-o"></i><i
                                className="font-13 fa fa-star-o"></i><i className="font-13 fa fa-star-o"></i><i
                                className="font-13 fa fa-star-o"></i></a></div>
                            </div>
                          </div>

                          <div className="spr-form-review-title">
                            <label className="spr-form-label" htmlFor="review_title_10508262282">Review Title</label>
                            <input className="spr-form-input spr-form-input-text " id="review_title_10508262282"
                                   type="text" name="review[title]" value="" placeholder="Give your review a title" />
                          </div>

                          <div className="spr-form-review-body">
                            <label className="spr-form-label" htmlFor="review_body_10508262282">Body of Review <span
                              className="spr-form-review-body-charactersremaining">(1500)</span></label>
                            <div className="spr-form-input">
                              <textarea className="spr-form-input spr-form-input-textarea " id="review_body_10508262282"
                    ...
                    <div className="spr-reviews">
                      <div className="spr-review">
                        <div className="spr-review-header">
                          <span className="product-review spr-starratings spr-review-header-starratings"><span
                            className="reviewLink"><i className="fa fa-star"></i><i
                            className="font-13 fa fa-star"></i><i className="font-13 fa fa-star"></i><i
                            className="font-13 fa fa-star"></i><i className="font-13 fa fa-star"></i></span></span>
                          <h3 className="spr-review-header-title">Lorem ipsum dolor sit amet</h3>
                          <span
                            className="spr-review-header-byline"><strong>dsacc</strong> on <strong>Apr 09, 2019</strong></span>
                        </div>
                        <div className="spr-review-content">
                          <p className="spr-review-content-body">Lorem ipsum dolor sit amet, consectetur adipiscing
                        ...
                        <div className="spr-review-header">
                          <span className="product-review spr-starratings spr-review-header-starratings">
                            <span
                              ...
                              <i className="font-13 fa fa-star"></i><i className="font-13 fa fa-star"></i><i
                              className="font-13 fa fa-star"></i><i className="font-13 fa fa-star"></i></span></span>
                          <h3 className="spr-review-header-title">Lorem Ipsum is simply dummy text of the printing</h3>
                          <span
                            className="spr-review-header-byline"><strong>larrydude</strong> on <strong>Dec 30, 2018</strong></span>
                        </div>

                        <div className="spr-review-content">
                          <p className="spr-review-content-body"><br/><br/>Lorem Ipsum is simply dummy text of the
                      ...
                      <div className="spr-review">
                        <div className="spr-review-header">
                          <span className="product-review spr-starratings spr-review-header-starratings"><span
                            ...
                            className="font-13 fa fa-star"></i><i className="font-13 fa fa-star"></i><i
                            className="font-13 fa fa-star"></i><i className="font-13 fa fa-star"></i></span></span>
                          <h3 className="spr-review-header-title">Neque porro quisquam est qui dolorem ipsum quia dolor
                        ...
                        <div className="spr-review-content">
                          <p className="spr-review-content-body">Lorem Ipsum is simply dummy text of the printing and
