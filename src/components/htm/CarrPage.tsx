        ...
        <div className="row">
          <div className="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
            <div className="alert alert-success text-uppercase" role="alert">
              <i className="icon anm anm-truck-l icon-large"></i> &nbsp;<strong>Congratulations!</strong> You've got
              free shipping!
            </div>
              ...
              <table>
                ...
                <tr className="cart__row border-bottom line1 cart-flex border-top">
                  <td className="cart__image-wrapper cart-flex-item">
                    <a href="#"><img className="cart__image" src="src/images/product-images/product-image30.jpg"
                  ...
                  <td className="cart__update-wrapper cart-flex-item text-right">
                    <div className="cart__qty text-center">
                      <div className="qtyField">
                        <a className="qtyBtn minus" href="javascript:void(0);"><i className="icon icon-minus"></i></a>
                        <input className="cart__qty-input qty" type="text" name="updates[]" id="qty" value="1"
                               pattern="[0-9]*" />
                        <a className="qtyBtn plus" href="javascript:void(0);"><i className="icon icon-plus"></i></a>
                      </div>
                    </div>
                  </td>
                  <td className="text-right small--hide cart-price">
                    <div><span className="money">$735.00</span></div>
                  </td>
                  <td className="text-center small--hide"><a href="#" className="btn btn--secondary cart__remove"
                                                             title="Remove tem"><i
                    className="icon icon anm anm-times-l"></i></a></td>
                </tr>
                <tr className="cart__row border-bottom line1 cart-flex border-top">
                  <td className="cart__image-wrapper cart-flex-item">
                    <a href="#"><img className="cart__image" src="src/images/product-images/home7-product5.jpg"
                ...
                <tr className="cart__row border-bottom line1 cart-flex border-top">
                  <td className="cart__image-wrapper cart-flex-item">
                    <a href="#"><img className="cart__image" src="src/images/product-images/home7-product4.jpg"
                ...
                <tr>
                  <td colSpan= {3} className="text-left"><a href="http://annimexweb.com/"
                                                           className="btn btn-secondary btn--small cart-continue">Continue
                    shopping</a></td>
                  <td colSpan= {3} className="text-right">
                    <button type="submit" name="clear" className="btn btn-secondary btn--small  small--hide">Clear
                      Cart
                    </button>
                    <button type="submit" name="update"
                            className="btn btn-secondary btn--small cart-continue ml-2">Update Cart
                    </button>
                  </td>
                </tr>
                </tfoot>
            ...
            <div className="row">
              ...
              <div className="col-12 col-sm-12 col-md-4 col-lg-4 mb-4">
                ...
                <form action="#" method="post">
                  ...
                  <div className="actionRow">
                    <div><input type="button" className="btn btn-secondary btn--small" value="Calculate shipping" />
                    </div>
                  </div>
                </form>
              </div>
                ...
                <div className="solid-border">
                  ...
                  <div className="row border-bottom pb-2 pt-2">
                    ...
                    <span className="col-12 col-sm-6 cart__subtotal-title cart__subtotal text-right"><span
                      className="money">$1001.00</span></span>
                  </div>
                  ...
                  <input type="submit" name="checkout" id="cartCheckout" className="btn btn--small-wide checkout"
                         value="Proceed To Checkout" disabled />
                  <div className="paymnet-img"><img src="src/images/payment-img.jpg" alt="Payment" /></div>
