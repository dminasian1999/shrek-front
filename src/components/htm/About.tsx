  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img className="blur-up lazyload"
                                                                       data-src="src/images/about1.jpg"
                                                                       src="src/images/about1.jpg" alt="About Us" />
          </div>
          <div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img className="blur-up lazyload"
                                                                       data-src="src/images/about2.jpg"
                                                                       src="src/images/about2.jpg" alt="About Us" />
          </div>
          <div className="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img className="blur-up lazyload"
                                                                       data-src="src/images/about3.jpg"
                                                                       src="src/images/about3.jpg" alt="About Us" />
          </div>
        </div>
        <div className="row">
          <div className="col-12">
            <h2>Sed ut perspiciatis unde omnis iste natus error</h2>
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, On the
              other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by
              the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain.</p>
            <p>simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing
        ...
        <div className="row">
          <div className="col-12 col-sm-12 col-md-6 col-lg-6 mb-4">
            ...
            <div className="rte-setting"><p><strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
              exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</strong></p>
